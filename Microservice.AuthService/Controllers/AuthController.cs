...
using Microservice.AuthService.Helpers;

namespace Microservice.AuthService.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register(RegisterModel model)
        {
            ...
            var confirmationLink = $"http://localhost:5173/confirm-email?userId={Uri.EscapeDataString(user.Id.ToString())}&token={encodedToken}";
